...
func TestTopicMetadataResponse(t *testing.T) {
	...
	decodeErr(t, new(TopicMetadataResponse), invalidBrokersLengthMetadataResponseBytes, EOF)
	decodeErr(t, new(TopicMetadataResponse), invalidMetadataLengthMetadataResponseBytes, EOF)
}
